...
Для того чтобы наша лабораторная завтра прошла успешно, нам нужно предварительно к ней подготовиться. Необходимо настроить VPN-соединение, установить VSCode и необходимые расширения.
За всеми вами закреплены виртуальные машины.

**Таблица закрепления виртуальных машин**

| ФИО участника | IP-адрес      |
| ------------- | ------------- |
| Иванов Иван   | 192.168.2.100 |
