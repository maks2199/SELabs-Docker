...
✅ Перед лабораторной работой, в пятницу, настроить и проверить подключение к виртуальной машине.
...
_XX — ваш номер хоста, от 01 до 19_\*
...
🔗 Подробнее про настройку подключения к ВМ с решением частых вопросов и проблем, а также со скриншотами, смотрите по ссылке: https://github.com/AndreyChuyan/se_labs
